...
const StudyAnalysis = () => {
  ...
  const loadMasteryData = async () => {
    try {
      // 在实际环境中，这里会调用真实的API
      // const response = await studyRecordService.getMasteryData()
      
      // 模拟掌握度数据
      const masteryData = [
        { category: '词语学习', masteryLevel: 85, color: '#1890ff' },
        { category: '成语学习', masteryLevel: 78, color: '#52c41a' },
        { category: '语法知识', masteryLevel: 62, color: '#faad14' },
        { category: '阅读理解', masteryLevel: 75, color: '#f5222d' },
        { category: '写作能力', masteryLevel: 58, color: '#722ed1' }
      ]
          ...
          <Card title="知识点掌握度分布" loading={loading}>
            <div className="mastery-list">
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
                <div style={{ width: 12, height: 12, backgroundColor: '#1890ff', marginRight: 8 }}></div>
                <span style={{ flex: 1 }}>词语学习</span>
                <span>85%</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
                <div style={{ width: 12, height: 12, backgroundColor: '#52c41a', marginRight: 8 }}></div>
                <span style={{ flex: 1 }}>成语学习</span>
                <span>78%</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
                <div style={{ width: 12, height: 12, backgroundColor: '#faad14', marginRight: 8 }}></div>
                <span style={{ flex: 1 }}>语法知识</span>
                <span>62%</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
                <div style={{ width: 12, height: 12, backgroundColor: '#f5222d', marginRight: 8 }}></div>
                <span style={{ flex: 1 }}>阅读理解</span>
                <span>75%</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
                <div style={{ width: 12, height: 12, backgroundColor: '#722ed1', marginRight: 8 }}></div>
                <span style={{ flex: 1 }}>写作能力</span>
                <span>58%</span>
              </div>
            </div>
          </Card>
